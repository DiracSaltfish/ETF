"""PCF fetch/cache implementation reused from 赎回收益计算器V3.

This vendored copy is kept inside the monitor package so the macOS app and the
Windows source delivery remain self-contained.  Upstream source:
``赎回收益计算器V3/szse_pcf.py``.
"""
